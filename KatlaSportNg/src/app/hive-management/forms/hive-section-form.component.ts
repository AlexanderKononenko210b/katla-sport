  ...
  onSubmit() {
      ...
      if(this.hiveId == 0)
    {
      this.hiveId = this.hiveSection.hiveId;
       ...
       return this.sectionService.addHiveSection(this.hiveId, this.updateSectionRequest)
        .subscribe(h => this.navigateTo());
    }
    else
    {
      return this.sectionService.updateHiveSection(this.hiveSection.id, this.updateSectionRequest)
        .subscribe(h => this.navigateTo());
    }
  }
